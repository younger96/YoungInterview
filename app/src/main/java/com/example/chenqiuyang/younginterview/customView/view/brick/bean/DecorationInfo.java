package com.example.chenqiuyang.younginterview.customView.view.brick.bean;
...
public class DecorationInfo {
    ...
    public DecorationInfo(int itemLeft, int itemRight, int itemTop, int itemBottom, BrickPositionInfo position) {
    ...
    public DecorationInfo(BrickPositionInfo position) {
        this.position = position;
    }
