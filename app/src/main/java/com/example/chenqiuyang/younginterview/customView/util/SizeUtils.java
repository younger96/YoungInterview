...
public final class SizeUtils {
    ...
    private static final float sDensity = App.getApplicationInstance().getResources().getDisplayMetrics().density;
    private static final float sScaledDensity = App.getApplicationInstance().getResources().getDisplayMetrics().scaledDensity;
    /**
     * dp转px
     *
     * @param dpValue dp值
    ...
    public static int px2sp(final float pxValue) {
        final float fontScale = App.getApplicationInstance().getResources().getDisplayMetrics().scaledDensity;
