package com.example.chenqiuyang.younginterview.customView.view.animatorbutton;
...
public class AnimationButton extends View {
    ...
    private void set_move_to_up_animation() {
        ...
        animator_move_to_up = ObjectAnimator.ofFloat(this, "translationY",
                curTranslationY, curTranslationY - move_distance);
